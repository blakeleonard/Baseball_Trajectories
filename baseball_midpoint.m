...
% balle - Program to compute the trajectory of a baseball using the Midpoint Method

clear;

disp('  balle - Program to compute the trajectory of a baseball');

disp('          using the Midpoint method.');
...
for jstep = 1:2                     							% 1st step: normal    2nd step: interpolated
	...
	if ( jstep == 1 )
		...
		legend('Midpoint Method', 'Theory (No air)', 'Ground' );

	else

		legend('Interpolated Midpoint method', 'Theory (No air)', 'Ground' );
